...
function conky_main_rings()
    ...
    rings_settings =
    {
        ...
        {
            name = "",
            arg = "${if_up wlp2s0}${wireless_link_qual_perc wlp2s0}$else 0${endif}",
            max = 100,
            xc = 57.5,
            yc = 274.5,
            start_angle = 180,
            ...
            sectors = 30,
            gap_sectors = 1,
            bg_colour1 = {{ 0.5, 0xFFFFFF, 0.3 }},
            fg_colour1 = {{ 0.5, 0xFFFF00, 0.6 }},
            fg_colour2 = {{ 0.5, 0x00FF00, 0.7 }}
        },
        {
            ...
            fg_colour2 = {{ 0.5, 0x00FF00, 0.6 }}
        },
        {
            -- most people won't have oss emulation module loaded. use this script instead
            -- name = "exec",
            -- arg = "~/.conky/bionic-contd/scripts/get-volume.sh",
            name = "mixer",
            max = 100,
            xc = 96,
            yc = 513.5,
